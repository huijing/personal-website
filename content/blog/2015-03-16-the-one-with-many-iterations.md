...
image: project-3
images: 
- /assets/images/posts/projects/project-3@2x.png
...
For the keyword search, you can actually use the filter criteria *Search: search terms* and it will pick up words found in any field of your content. Referenced from [this post](https://www.drupal.org/node/680442). We also used jQuery to make two of the fields conditional.
...
<pre class="language-javascript"><code>var $monthAndYear = $('.views-widget-filter-field_date_value');
$monthAndYear.hide();
...
![Raw data](/assets/images/posts/rhc/rhc-2.jpg)
...
1. <p class="no-margin"><strong>Convert hyperlinks to text</strong></p>
    ...
    <pre><code class="language-bash">Dim Cell As Range 
...
3. <p class="no-margin"><strong>Adjust data as necessary</strong></p>
    ...
    <img alt="Transpose data" src="/assets/images/posts/rhc/rhc-3.jpg">
