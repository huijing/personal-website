...
hascodepen: true
images: 
- /assets/images/posts/2d-transforms.jpg
...
<img alt="Transform default origin" srcset="/assets/images/posts/css-transforms/origin@2x.jpg 2x" src="/assets/images/posts/css-transforms/origin.jpg">
...
<img alt="Transform origin at (70px 100px)" srcset="/assets/images/posts/css-transforms/origin2@2x.jpg 2x" src="/assets/images/posts/css-transforms/origin2.jpg">
...
This is easier to understand by adjusting the sliders below. You can also specify <code>scaleX()</code> or <code>scaleY()</code> which grow or shrink the element along the x-axis and y-axis respectively. For <code>scaleX()</code>, only the *x-coordinate* of the transform origin is relevant, and for <code>scaleY()</code>, only the *y-coordinate* is relevant.
