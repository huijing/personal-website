...
images: 
- /assets/images/posts/html-ruby.jpg
slug: html-ruby
tags:
- html
- i18n
...
<figure>
  ...
  {{<img filename="posts/html-ruby/sendoh" filetype="jpg" alt="Slamdunk manga">}}
</figure>
...
<figure>
  ...
  {{<img filename="posts/html-ruby/textbook" filetype="jpg" alt="Kindergarten textbook">}}
</figure>
...
{{<img2x filename="posts/html-ruby/complex" filetype="jpg" alt="Complex ruby markup">}}
...
<div class="grid-inline">
    <figure>
        ...
        {{<img filename="posts/html-ruby/over-h" filetype="jpg" alt="Over (horizontal)">}}
        {{<img filename="posts/html-ruby/over-v" filetype="jpg" alt="Over (vertical)">}}
    </figure>
    <figure>
        <figcaption>ruby-position: under</figcaption>
        {{<img filename="posts/html-ruby/under-h" filetype="jpg" alt="Under (horizontal)">}}
        {{<img filename="posts/html-ruby/under-v" filetype="jpg" alt="Under (vertical)">}}
    </figure>
    <figure>
        <figcaption>ruby-position: inter-character</figcaption>
        {{<img filename="posts/html-ruby/inter" filetype="jpg" alt="Inter-character">}}
    </figure>
</div>
...
<ul>
  ...
  <li class="no-margin"><a href="https://web.archive.org/web/20190125202728/http://www.html5.jp/tag/elements/ruby.html">ruby 要素</a></li>
