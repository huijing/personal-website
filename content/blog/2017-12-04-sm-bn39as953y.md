...
<figure>
    ...
    <img srcset="/assets/images/posts/grid-inspector/layout-panel-480.png 480w, /assets/images/posts/grid-inspector/layout-panel-640.png 640w, /assets/images/posts/grid-inspector/layout-panel-960.png 960w, /assets/images/posts/grid-inspector/layout-panel-1280.png 1280w" sizes="(max-width: 400px) 100vw, (max-width: 960px) 75vw, 640px" src="/assets/images/posts/grid-inspector/layout-panel-640.png" alt="Firefox DevTools layout panel" />
</figure>
...
<figure>
    ...
    <video src="/assets/videos/gi-name-tooltip.mp4" controls></video>
</figure>
...
<figure>
    ...
    <img srcset="/assets/images/posts/grid-inspector/grid-colour-480.png 480w, /assets/images/posts/grid-inspector/grid-colour-640.png 640w, /assets/images/posts/grid-inspector/grid-colour-960.png 960w, /assets/images/posts/grid-inspector/grid-colour-1280.png 1280w" sizes="(max-width: 400px) 100vw, (max-width: 960px) 75vw, 640px" src="/assets/images/posts/grid-inspector/grid-colour-640.png" alt="Change the colours on the grid overlay" />
</figure>
...
<figure>
    ...
    <video src="/assets/videos/gi-area-highlight.mp4" controls></video>
</figure>
...
<figure>
    ...
    <img srcset="/assets/images/posts/grid-inspector/waffle-480.png 480w, /assets/images/posts/grid-inspector/waffle-640.png 640w, /assets/images/posts/grid-inspector/waffle-960.png 960w, /assets/images/posts/grid-inspector/waffle-1280.png 1280w" sizes="(max-width: 400px) 100vw, (max-width: 960px) 75vw, 640px" src="/assets/images/posts/grid-inspector/waffle-640.png" alt="Click on the waffle-like icon" />
</figure>
...
<figure>
    ...
    <video src="/assets/videos/gi-line-numbers.mp4" controls></video>
</figure>
...
<div class="figure-wrapper">
    <figure class="multiple">
        ...
        <img src="/assets/images/posts/grid-inspector/cut-off1.png" srcset="/assets/images/posts/grid-inspector/cut-off1@2x.png 2x" />
    </figure>
    <figure class="multiple">
        <figcaption>Line numbers cut off at the side edge</figcaption>
        <img src="/assets/images/posts/grid-inspector/cut-off2.png" srcset="/assets/images/posts/grid-inspector/cut-off2@2x.png 2x" />
    </figure>
</div>
...
<figure>
    ...
    <video src="/assets/videos/gi-area-name.mp4" controls></video>
</figure>
...
<figure>
    ...
    <img srcset="/assets/images/posts/grid-inspector/area-name-480.png 480w, /assets/images/posts/grid-inspector/area-name-640.png 640w, /assets/images/posts/grid-inspector/area-name-960.png 960w, /assets/images/posts/grid-inspector/area-name-1280.png 1280w" sizes="(max-width: 400px) 100vw, (max-width: 960px) 75vw, 640px" src="/assets/images/posts/grid-inspector/area-name-640.png" alt="View grid area names on grid overlay" />
</figure>
...
<figure>
    ...
    <video src="/assets/videos/gi-extend-lines.mp4" controls></video>
</figure>
...
<figure>
    ...
    <video src="/assets/videos/gi-box-model.mp4" controls></video>
</figure>
...
<figure>
    ...
    <video src="/assets/videos/gi-transforms.mp4" controls></video>
</figure>
...
<figure>
    ...
    <img srcset="/assets/images/posts/grid-inspector/bugzilla-480.png 480w, /assets/images/posts/grid-inspector/bugzilla-640.png 640w, /assets/images/posts/grid-inspector/bugzilla-960.png 960w, /assets/images/posts/grid-inspector/bugzilla-1280.png 1280w" sizes="(max-width: 400px) 100vw, (max-width: 960px) 75vw, 640px" src="/assets/images/posts/grid-inspector/bugzilla-640.png" alt="Raise any issues you find at Bugzilla" />
</figure>
