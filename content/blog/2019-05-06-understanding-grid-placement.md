...
hastweet: true
images: 
- /assets/images/posts/grid-placement.jpg
...
<figure>
  ...
  <img src="/assets/images/posts/grid-placement/manual.png" srcset="/assets/images/posts/grid-placement/manual@2x.png 2x" alt="Screenshot of a 3x3 grid with 3 grid items styled like a chessboard and pieces">
</figure>
...
<img srcset="/assets/images/posts/grid-placement/anonymous-480.png 480w, /assets/images/posts/grid-placement/anonymous-640.png 640w, /assets/images/posts/grid-placement/anonymous-960.png 960w, /assets/images/posts/grid-placement/anonymous-1280.png 1280w" sizes="(max-width: 400px) 100vw, (max-width: 960px) 75vw, 640px" src="/assets/images/posts/grid-placement/anonymous-640.png" alt="Inline box construction showing 3 anonymous line boxes and 2 element line boxes">
...
<figure>
  ...
  <img srcset="/assets/images/posts/grid-placement/implicit-480.png 480w, /assets/images/posts/grid-placement/implicit-640.png 640w, /assets/images/posts/grid-placement/implicit-960.png 960w, /assets/images/posts/grid-placement/implicit-1280.png 1280w" sizes="(max-width: 400px) 100vw, (max-width: 960px) 75vw, 640px" src="/assets/images/posts/grid-placement/implicit-640.png" alt="Box placed outside the explicit grid, causing the generation of implicit grid columns to accommodate it">
</figure>
...
<img srcset="/assets/images/posts/grid-placement/implicit-grid-480.png 480w, /assets/images/posts/grid-placement/implicit-grid-640.png 640w, /assets/images/posts/grid-placement/implicit-grid-960.png 960w, /assets/images/posts/grid-placement/implicit-grid-1280.png 1280w" sizes="(max-width: 400px) 100vw, (max-width: 960px) 75vw, 640px" src="/assets/images/posts/grid-placement/implicit-grid-640.png" alt="Implicit grid tracks generated to accommodate a grid item placed on column 6 but spans 3 columns, resulting in the generation of 6 more implicit columns">
...
<img src="/assets/images/posts/grid-placement/html-grid.svg" alt="Mock-up of the letters HTML in a 20x10 grid">

But wait, if you look a little closer, you'll notice something is not quite aligned properly.

<img src="/assets/images/posts/grid-placement/html-grid2.svg" alt="Diagram showing misaligned tiles in the letter M">
...
<img src="/assets/images/posts/grid-placement/html-grid3.svg" alt="Mock-up of the letters HTML in a 40x10 grid">
...
<img src="/assets/images/posts/grid-placement/classes.svg" alt="Adding classes for easier column position assignment">
...
<img srcset="/assets/images/posts/grid-placement/dense-480.png 480w, /assets/images/posts/grid-placement/dense-640.png 640w, /assets/images/posts/grid-placement/dense-960.png 960w, /assets/images/posts/grid-placement/dense-1280.png 1280w" sizes="(max-width: 400px) 100vw, (max-width: 960px) 75vw, 640px" src="/assets/images/posts/grid-placement/dense-640.png" alt="Auto-placed grid items get packed into unoccupied cells when grid-auto-flow gets set to dense">
...
<img srcset="/assets/images/posts/grid-placement/wide-480.png 480w, /assets/images/posts/grid-placement/wide-640.png 640w, /assets/images/posts/grid-placement/wide-960.png 960w, /assets/images/posts/grid-placement/wide-1280.png 1280w" sizes="(max-width: 400px) 100vw, (max-width: 960px) 75vw, 640px" src="/assets/images/posts/grid-placement/wide-640.png" alt="The original target design only works well on a wide viewport">
...
<img srcset="/assets/images/posts/grid-placement/flex-480.png 480w, /assets/images/posts/grid-placement/flex-640.png 640w, /assets/images/posts/grid-placement/flex-960.png 960w, /assets/images/posts/grid-placement/flex-1280.png 1280w" sizes="(max-width: 400px) 100vw, (max-width: 960px) 75vw, 640px" src="/assets/images/posts/grid-placement/flex-640.png" alt="Fallback layout implemented with flexbox">
